  ...
  <head>
	...
	.banner-nissan {
		...
		width: 100%;
 		min-height: 20%;
		min-width: 30%;
		background-image: url("bannercicd.png");
    ...
    <header>
      ...
      <div class="navbar navbar-dark bg-dark box-shadow" style=" background-color:#f2f2f2!important;">
        <div class="container d-flex justify-content-between">
          <h2>CI/CD Pipeline Using Git, GitHub, Docker, Maven and Jenkins</h2
      ...
      <div class="album py-5 bg-light">
		...
		<div class="container">
		 <div class="row">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" src="jenkins.png" alt="Card image cap">
                <div class="card-body">
                  <p class="card-text">Automation with Jenkins</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-secondary">View</button>
                      <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
               ...
               <h2></h2>
                ...
                <div class="card-body">
                  <img class="card-img-top" src="aws.png" alt="Card image cap">
                  <p class="card-text">Scalable and secure infrastructure with AWS</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-secondary">View</button>
                      <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
